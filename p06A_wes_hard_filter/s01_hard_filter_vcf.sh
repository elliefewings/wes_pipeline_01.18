...
#Edited by EF and AL to retain hard filered variants with column including whether they should pass or fail filters
...
then 
  ...
  # Progress report
  echo "Omit removing filtered variants from vcf"
  cp -f "${filt_vcf}" "${cln_vcf}"
